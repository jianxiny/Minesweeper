...
import { RootState } from '../../GameWithRedux/store'
import { openCell as openCellHandler } from '../../useGame'
...
export const getInitialState = (level: LevelNames = beginnerLevel): State => {
...
export const gameSlice = createSlice({
  ...
  reducers: {
    ...
    changeLevel: (_, { payload }: PayloadAction<LevelNames>) =>
